...
proc check_dir {dir} {
  ...
  foreach msg_file [glob -nocomplain -directory "$CFG_SPOOL_DIR/$dir/new" *.*] {
...
if {![file exists $CFG_SPOOL_DIR/dxrobot/new/archive]} {
  file mkdir $CFG_SPOOL_DIR/dxrobot/new/archive
}

if {![file exists $CFG_SPOOL_DIR/vhfdx/new/archive]} {
  file mkdir $CFG_SPOOL_DIR/vhfdx/new/archive
}
